...
class UserPreferencesRepoImpl(
    ...
    override suspend fun saveProfileImageUri(email: String, uri: String) =
        dataStoreManager.saveProfileImageUri(email, uri)

    override suspend fun getProfileImageUri(email: String): String? =
        dataStoreManager.getProfileImageUri(email)
